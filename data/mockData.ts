...
export const mockBookings: Booking[] = [
  ...
  },
  {
    id: "booking-3",
    skillId: "skill-5",
    skillTitle: "Python Programming Introduction",
    offeredSkillId: "skill-4",
    offeredSkillTitle: "Digital Photography Tips",
    requesterId: "user-4",
    requesterName: "Emma Davis",
    providerId: "user-1",
    providerName: "Hira Khan",
    message: "I would love to learn Python! Can offer photography in exchange.",
    status: "pending",
