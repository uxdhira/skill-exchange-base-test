...
import { brandListType } from "@/types/slider";
import { RepeatIcon, Zap } from "lucide-react";
import { motion } from "motion/react";

 

function BrandSlider({ brandList }: { brandList: brandListType[] }) {
  return (
    <section>
            ...
            <div className="flex justify-center text-center py-3 md:py-4 relative">
              <div className="flex items-center justify-center gap-4">
                ...
                <p className="text-sm font-normal sm:px-2 px-10 text-muted-foreground text-center">
                  Loved by 1000+ people around the worlds
                </p>
