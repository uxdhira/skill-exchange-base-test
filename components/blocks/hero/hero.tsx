            ...
            <div className="flex flex-col max-w-5xl mx-auto gap-8">
              <div className="relative  flex flex-col text-center items-center sm:gap-6 gap-4">
                <motion.h1
                  ...
                  className="lg:text-6xl md:text-4xl  max-w-2xl text-5xl font-medium leading-14 md:leading-20 lg:leading-18"
                >
                  Opportunity to Skill Mastery{" "}
                  <span
                ...
                >
                  Unlock your potential, from coding to creativity. Join a
                  community where curiosity meets expertise. Explore skills
                  you’ve always wanted to master. Share what you know and
